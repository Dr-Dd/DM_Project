...
of publishing, both Apache Jena Fuseki and PostgreSQL spend around 0.4
seconds to get a result, as long as the relational database has an
index on \texttt{nameBasics.primaryName}. As such, graph databases
allow for faster development and expansion of functionalities, since
